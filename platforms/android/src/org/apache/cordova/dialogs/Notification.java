    ...
    public synchronized void prompt(final String message, final String title, final JSONArray buttonLabels, final String defaultText, final CallbackContext callbackContext) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                LinearLayout.LayoutParams textLayout = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                LinearLayout linearLayout = new LinearLayout(cordova.getActivity());

                linearLayout.setPadding(40, 0, 40, 0);
                linearLayout.setLayoutParams(textLayout);
                linearLayout.addView(promptInput);
                promptInput.setLayoutParams(textLayout);
